...
public class add_pengembalian extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(add_pengembalian.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void save() {
        ...
        if (empty(getnis) || empty(getkode) || empty(gettanggal)) {
            ...
            try {
                Connection con = new database.connection().configDB();
                String get = "SELECT * FROM pengembalian WHERE nis = '"+getnis+"' AND kode_buku = '"+getkode+"'";
                java.sql.Statement st = con.createStatement();
