 ...
 * @author User
 */
public class edit_pengembalian extends javax.swing.JDialog {
     ...
     */
    public edit_pengembalian(java.awt.Frame parent, boolean modal, String id) {
        super(parent, modal);
        ...
        id_pengembalian.setVisible(false);
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Tanggal Pengembalian (YYYY-MM-DD)");
                            ...
                            .addGroup(bodyLayout.createSequentialGroup()
                                .addGroup(bodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(bodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(cari_buku, javax.swing.GroupLayout.Alignment.LEADING)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(edit_pengembalian.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                edit_pengembalian dialog = new edit_pengembalian(new javax.swing.JFrame(), true,0+"");
     ...
     private void tampil_data(String id) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                kode.setText(rs.getString("kode_buku"));
                judul.setText(rs.getString("judul_buku"));
                tanggal.setText(rs.getString("tanggal_kembali"));
                
                try {
                    String sql2 = "SELECT * FROM buku WHERE kode = '"+rs.getString("kode_buku")+"'";
                    ...
                    JOptionPane.showMessageDialog(null, "Gagal menampilkan Fram!", "Kesalahan", JOptionPane.ERROR_MESSAGE);
                    this.setVisible(false);
                }
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Gagal menampilkan Frames!", "Kesalahan", JOptionPane.ERROR_MESSAGE);
            this.setVisible(false);
        }
    }
    ...
    private void clicktbl_murid() {
        ...
        Object []rows = {"Kode Buku", "Judul Buku", "Tanggal Pinjam"};
        tbl1 = new DefaultTableModel(null, rows) {
            public boolean isCellEditable(int row, int column) {
                return false;
            }
        };
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String tanggal_pinjam = rs.getString("tanggal");
                
                String[] data = {kode_buku, judul_buku, tanggal_pinjam};
                tbl1.addRow(data);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Gagal Menampilkan DATA!", "Kesalahan", JOptionPane.ERROR_MESSAGE);
    ...
    private void save() {
        ...
        if (!empty(gettanggal)) {
            ...
            JOptionPane.showMessageDialog(null, "Silahkan masukkan Tanggal Pengembalian!", "Peringatan!", JOptionPane.WARNING_MESSAGE);
        }
    }
